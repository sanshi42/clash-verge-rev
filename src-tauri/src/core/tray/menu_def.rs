...
define_menu! {
    ...
    auto_launch => AUTO_LAUNCH, "tray_auto_launch", "tray.autoLaunch",
    tray_speed => TRAY_SPEED, "tray_tray_speed", "tray.traySpeed",
    allow_lan => ALLOW_LAN, "tray_allow_lan", "tray.allowLan",
    ...
    connections => CONNECTIONS, "tray_connections", "tray.connections",
    profile_page => PROFILE_PAGE, "tray_profile_page", "tray.config",
    settings => SETTINGS, "tray_settings", "tray.settings",
